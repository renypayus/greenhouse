...
<footer id="footer" role="contentinfo" >
    <div class="container">
                <div class="row">
            <div class="box col-md-4 col-sm-6 d-none d-sm-none d-md-block">
                <a class="footer-brand" href="<?php //echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/logos/greenhouse-type-logo.svg" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" itemprop="" height="12"/></a>
            ...
            <div class="box col-md-4 col-sm-6 d-block d-md-none d-lg-none">
            <a class="footer-brand" href="<?php //echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/logos/greenhouse-type-logo.svg" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" itemprop="" height="12"/></a>
                <p class="site-info"><small>Copyright © 2018 Greenhouse. All rights reserved</small></p>
            </div>
        </div>
